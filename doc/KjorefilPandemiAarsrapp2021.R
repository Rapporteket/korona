...
#setwd('../home/rstudio/speil/aarsrapp/pandemi') #/aarsrapp/pandemi')
setwd('../speil/aarsrapp/pandemi')

library(intensiv)
library(intensivberedskap)
library(korona)
datoFra <- '2021-01-01' #Vi har pandemi fra 1.mars 2020
datoTil <- '2021-12-31'	#
...
KoroData <- korona::LeggTilNyInnOverf(RegData=KoroData, PasientID='PasientID')
