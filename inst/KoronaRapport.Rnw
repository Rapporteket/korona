...
Hvis ikke annet er angitt, er \textit{kun pasienter hvor Covid-19 er hovedårsak til innleggelsen}, tatt med. Hvis pasienten er overført, skal minimum siste opphold ha Covid-19 som hovedårsak til innleggelsen.
