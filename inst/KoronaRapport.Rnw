...
aggregert til ett forløp per pasient, uavhengig av om pasienten har reinnleggelser eller flere forløp. Per i dag er det \Sexpr{antPasFlereForl} som har mer enn ett forløp med Covid-19.
