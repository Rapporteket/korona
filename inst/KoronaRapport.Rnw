...
Denne burde vel heller vise kumulativt antall...?
...
xtable::xtable(AntUtRHF, digits=0, #method='compact', #align=c('l', rep('r', ncol(alderDIV))),
...
#Form status: 0 = Ingen	1 = Kladd	2 = Ferdigstilt	4 = Slettet	5 = Returnert
AntKladdShus <- table(Pandemi$ShNavn[indKladd], dnn= 'Skjema i kladd')
