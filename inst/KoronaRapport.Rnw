...
Tittel <- paste0('\bf{Norsk intensiv- og pandemiregister (NIPaR)} \\
...
Dokumentet inneholder oversikt over sykehusbehandlede pasienter med covid-19 for \textbf{\Sexpr{forHvem}}.
...
xtable::xtable(BeleggTab[fra:AntRader, ],
...
print(xtable::xtable(AntUt[fra:nrow(AntUt),], digits=0, method='compact', #align=c('l', rep('r', ncol(alderDIV))),
                              caption='Antall avsluttede opphold (utskrevne) med covid-19 som hovedårsak siste 20 dager, s
                     amt totalt antall fra 8. mars 2020 til rapporteringstidspuktet.'),
scalebox = skalering)
