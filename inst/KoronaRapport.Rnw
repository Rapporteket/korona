...
uavhengig av om pasienten har reinnleggelser. For personaggregerte resultater vises pasienter
...
At et opphold er ferdigstilt vil si at opplysningene er kontrollert og ferdig registrert.
...
aggregert til ett forløp per pasient, uavhengig av om pasienten har reinnleggelser eller flere forløp.
Per i dag er det \Sexpr{antPasFlereForl} som har mer enn ett forløp med Covid-19.
...
print(xtable::xtable(AntUt[fra:nrow(AntUt),], digits=0, method='compact', #align=c('l', rep('r', ncol(alderDIV))),
                     ...
                     samt totalt antall fra 8. mars 2020 til rapporteringstidspuktet.'),
      scalebox = skalering)
...
print(xtable::xtable(RegHF, row.names=FALSE, digits=0,
                     ...
                     fra 8. mars 2020 til rapporteringstidspunktet.'),
      include.rownames = FALSE)
@
\end{frame}
...
dum <- AlderKjFig(RegData=Pandemi,
...
xtable::xtable(RisikoTab, #digits=0, #method='compact', #align=c('l', rep('r', ncol(alderDIV))),
               caption='Hyppighet av risikofaktorer på rapporteringstidspunktet for
               ferdigstilte opphold hvor covid-19 var hovedårsak til innleggelsen.
...
#print(
  xtable::xtable(FerdigeReg, align=c('l','r','r','c','r','r'),
               #digits=0, #method='compact', #align=c('l', rep('r', ncol(alderDIV))),
               caption='Verdier på rapporteringstidspunktet for utskrevne pasienter hvor både
               inklusjonsskjema og utskrivingsskjema er ferdigstilt.
