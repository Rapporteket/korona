...
%Det er \Sexpr{N-antFerdig} av de \Sexpr{N} skjemaene som ikke er ferdigstilt.
\item For å luke bort feilregistreringer, er registrering av innleggelse før 15.februar, filtrert bort.
%\item Det er registrert \Sexpr{DodBekr} døde.
...
#Form status: 0 = Ingen	1 = Kladd	2 = Ferdigstilt	4 = Slettet	5 = Returnert
RisikoTab <- RisikoInnTab(RegData=PandemiInn, skjemastatus = 2)$Tab

xtable::xtable(addmargins(RisikoTab), digits=0, #method='compact', #align=c('l', rep('r', ncol(alderDIV))),
