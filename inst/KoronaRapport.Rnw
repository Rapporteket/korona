...
\title[Pandemiregister \\\today]{Koronainnlagte på sykehus} %\\\today}
...
Dokumentet inneholder oppsummering av disse registreringene. Med mindre annet er angitt, er \textit{kun pasienter
...
#Form status: 0 = Ingen	1 = Kladd	2 = Ferdigstilt	4 = Slettet	5 = Returnert
AntKladdShus <- table(PandemiAlle$ShNavn[which(PandemiAlle$FormStatus==1)], dnn= 'Skjema i kladd')
