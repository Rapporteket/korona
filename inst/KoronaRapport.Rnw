...
print(xtable::xtable(FerdigeReg, align=c('l','r','r','c','r','r'),
...
#print(xtable::xtable(AntTab[(nrow(AntTab)-20):nrow(AntTab), ], digits=0,
#               method='compact', #align=c('l', rep('r', ncol(alderDIV))),
...
print(xtable::xtable(InneliggPas, digits=0,
               caption='Antall inneliggende pasienter (mangler utskrivingsskjema) på hver enhet,
...
xTab <- xtable::xtable(AntUt[fra:nrow(AntUt),], digits=0, #method='compact', #align=c('l', rep('r', ncol(alderDIV))),
                              caption='Antall utskrevne per dag siste 20 utskrivningsdager, samt totalt.')
...
xtable::xtable(AntDodeTab[fra:nrow(AntDodeTab),], digits=0, #method='compact', #align=c('l', rep('r', ncol(alderDIV))),
                              caption='Antall døde per dag, siste 20 dødsdager,
...
kladdTxt <- ''
Kladd <- if (length(AntKladdShus)>0) {
 ...
 } else {kladdTxt <- paste0 ('Ingen skjema i kladd i ', valgtEnhet)}
@
\Sexpr{kladdTxt}
\end{frame}
